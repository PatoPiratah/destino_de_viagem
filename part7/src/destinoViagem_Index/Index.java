...
public class Index {
	...
	public static void main(String[] args) {
		...
		List<ListaFila> Fila1 = new ArrayList();
		List<ListaPilha> Pilha1 = new ArrayList();
		...
		Destino d6 = new Destino("Munique", "Alemanha");
		Destino d7 = new Destino("Rio de Janeiro", "Brasil");
		
		try {
			Viagem v1 = new Viagem(p1, LocalDate.of(2011, 03, 20), 
					LocalDate.of(2012, 11, 22));
			
			((ListaFila) Pilha1).Inserir(v1);
			((ListaFila) Fila1).Inserir(v1);
		...
		try {
			...
			((ListaFila) Fila1).Inserir(v2);
			((ListaFila) Pilha1).Inserir(v2);
		...
		try{ Viagem v3 = new Viagem(p2, LocalDate.of(2021, 05, 23), 
		 ...
		 ((ListaFila) Fila1).Inserir(v3);
		 ((ListaFila) Pilha1).Inserir(v3);
		...
		((ListaFila) Fila1).Remover();
		System.out.println("\n	Remoção Fila: \n"+Fila1);
		
		System.out.println("\nIdentificadores: \n"+IdentificadorDeGerenciamentoDeViagens.identificar((ListaFila)Fila1));
		...
		System.out.println("\n	Pilha Completa: \n"+Pilha1);
		((ListaPilha) Pilha1).Remover();
		System.out.println("\n	Remoção Pilha: \n"+Pilha1);
		
		System.out.println("\nIdentificadores: "+IdentificadorDeGerenciamentoDeViagens.identificar((ListaPilha) Pilha1));
